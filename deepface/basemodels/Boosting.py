...
def validate_model(model):
    ...
    if ('VGG-Face' in found_models) and ('Facenet' in found_models) and ('OpenFace' in found_models) and (
        ...
        raise ValueError(
            "You'd like to apply ensemble method and pass pre-built models but models must contain [VGG-Face, Facenet, OpenFace, DeepFace] but you passed " + str(
                found_models) + ". So, you need to pass " + str(missing_ones) + " models as well.")
