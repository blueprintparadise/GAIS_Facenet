    ...
    while (True):
        ...
        if freeze == True:
            ...
            if (toc - tic) < time_threshold:
                    ...
                    for detected_face in detected_faces_final:
                        ...
                        if custom_face.shape[1:3] == input_shape:
                            if df.shape[0] > 0:  # if there are images to verify, apply face recognition
                                ...
                                print(values_[0].split("\\")[-1].split("/")[0])
                                # print(str(threshold-Threshold_setter))
                                # print(str(best_distance)+' Best Distance')
                                # if True:
                ...
                cv2.rectangle(Fin_img, (10, 10), (180, 50), (67, 67, 67), -10)
                cv2.putText(Fin_img, str(values_[0].split("\\")[-1].split("/")[0]), (20, 40), cv2.FONT_HERSHEY_SIMPLEX,
                            1, (255, 255, 255), 1)
